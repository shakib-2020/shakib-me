...
function Nav() {
  return (
    <nav className="navbar navbar-expand-lg navbar-light sticky-top" id="top">
              ...
              <ul className="list-unstyled mb-0 list-inline social-icons">
                <li className="list-inline-item">
                  <a
                    ...
                    href="https://www.facebook.com/mdnazmus.shakib.378/"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/shakib-2020"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://twitter.com/Shakib265"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.instagram.com/naz__shakib/"
                  >
